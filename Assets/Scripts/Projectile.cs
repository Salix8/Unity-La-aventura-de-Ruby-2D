...
public class Projectile : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        // projectileAudio.PlayOneShot(cogCollideClip);
        /*  Mucho mas intuitivo seria esto si funcionase
         * RubyController controller = GetComponent<RubyController>();//Esta linea no funca // creo que le falta algo delante de GetComponente
         * controller.PlaySound(cogCollideClip);
        */
    }
